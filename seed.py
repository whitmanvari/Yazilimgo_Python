...
def seed_verileri_yukle():
    ...
    if session.query(KazanimTanimi).first() is None:
        rozet1 = KazanimTanimi(kazanim_adi="İlk Kan", aciklama="İlk dersini başarıyla tamamladın!", ikon_yolu="ilk_kan", xp_odulu=50)
        rozet2 = KazanimTanimi(kazanim_adi="Döngü Ustası", aciklama="Döngüler konusunda pratik yaptın.", ikon_yolu="dongu", xp_odulu=100)
        rozet3 = KazanimTanimi(kazanim_adi="Hata Avcısı", aciklama="Sistemi hiç çökertmeden kodu çalıştırdın.", ikon_yolu="hata", xp_odulu=150)
        rozet4 = KazanimTanimi(kazanim_adi="Veri Bükücü", aciklama="SQL Modülüne başarıyla giriş yaptın.", ikon_yolu="sql", xp_odulu=200)
